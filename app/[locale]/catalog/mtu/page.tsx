...
const copy = {
  ru: {
    title: "Каталог",
    intro:
      "Каталог запчастей и компонентов для промышленных двигателей. Наличие, срок поставки и совместимость уточняем по артикулу, серийному номеру двигателя или спецификации оборудования.",
    note:
      "Каталог пополняется. Мы добавляем новые позиции и уточняем технические описания. Для подбора отправьте артикул или спецификацию оборудования.",
    eyebrow: "B2B-каталог",
    disclaimer:
  ...
  en: {
    title: "Catalog",
    intro:
      "Catalog of spare parts and components for industrial engines. Stock status, lead time, and compatibility are confirmed by part number, engine serial number, or equipment specification.",
    note:
      "The catalog is being expanded. We are adding items and refining technical descriptions. Send a part number or equipment specification for selection.",
    eyebrow: "B2B catalog",
    disclaimer:
  ...
  zh: {
    title: "目录",
    intro:
      "为工业发动机供应 MTU 备件和部件。库存状态、交期和兼容性将根据零件号、发动机序列号或设备规格确认。",
    note:
